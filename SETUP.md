...
1. Install [fluentd](https://github.com/fluent/fluentd)

*If you plan to use fluentd for your product feel free to copy this repository to your project and change variables as needed.*
